...
const EmergencyDetectionOutputSchema = z.object({
  isEmergency: z.boolean().describe('Whether the user input suggests an emergency situation.'),
  emergencyAdvice: z.string().describe('Advice to seek emergency medical care if an emergency is detected.'),
});
